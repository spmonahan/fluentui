...
const useStyles = makeStyles({
  ...
  warning: theme => ({
    ...
    ...macros.borderColor('#c50f1f'), // FIXME theme.global.palette.cranberry.primary,
  }),
  important: theme => ({
    backgroundColor: '#242424', // FIXME theme.global.palette.grey[14],
    ...macros.borderColor('#242424'), // FIXME theme.global.palette.grey[14],
  }),
  severe: theme => ({
    ...
    ...macros.borderColor('#d13438'), // FIXME theme.global.palette.red.primary,
  }),
  informative: theme => ({
    backgroundColor: '#ebebeb', // FIXME theme.global.palette.grey[92],
    ...macros.borderColor('#ebebeb'), // FIXME theme.global.palette.grey[92],
